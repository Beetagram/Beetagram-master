...
public class UserConfig {
    ...
    public static void saveConfig(boolean withFile, File oldFile) {
        synchronized (sync) {
            try {
                SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("userconfing_"+ApplicationLoader.currentUser, Context.MODE_PRIVATE);
    ...
    public static void loadConfig() {
        synchronized (sync) {
            ...
            final File configFile = new File(ApplicationLoader.getFilesDirFixed(), ApplicationLoader.currentUser +"_"+ApplicationLoader.currentUser + "user.dat");
            if (configFile.exists()) {
                ...
                if (!notificationsConverted) {
                    try {
                        ...
                        preferences = ApplicationLoader.applicationContext.getSharedPreferences("Notifications_"+ApplicationLoader.currentUser, Context.MODE_PRIVATE);
