...
public class VoIPService extends VoIPBaseService implements NotificationCenter.NotificationCenterDelegate{
	...
	protected void updateServerConfig(){
		final SharedPreferences preferences = getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, MODE_PRIVATE);
	...
	private void startRinging() {
		...
		//ringtone.play();
		SharedPreferences prefs = getSharedPreferences("Notifications_"+ApplicationLoader.currentUser, MODE_PRIVATE);
	...
	private void initiateActualEncryptedCall() {
		...
		try {
			...
			switch(getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, MODE_PRIVATE).getInt("calls_p2p_new", MessagesController.getInstance().defaultP2pContacts ? 1 : 0)){
				case 0:
					allowP2p=true;
					break;
				case 2:
			...
			SharedPreferences prefs=ApplicationLoader.applicationContext.getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE);
