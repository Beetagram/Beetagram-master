...
public class MessagesStorage {
    ...
    private DispatchQueue storageQueue = new DispatchQueue("storageQueue"+ApplicationLoader.currentUser);
    ...
    public void openDatabase(boolean first) {
        cacheFile = new File(ApplicationLoader.getFilesDirFixed(), ApplicationLoader.currentUser + "cache4.db");
        ...
        storageQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("Notifications_"+ApplicationLoader.currentUser, Context.MODE_PRIVATE);
