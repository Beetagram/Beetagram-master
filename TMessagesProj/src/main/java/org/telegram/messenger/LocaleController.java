...
public class LocaleController {
    ...
    private void saveOtherLanguages() {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("langconfig_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE);
