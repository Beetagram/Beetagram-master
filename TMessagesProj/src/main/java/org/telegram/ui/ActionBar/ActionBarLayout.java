...
public class ActionBarLayout extends FrameLayout {
    ...
    public boolean presentFragment(final BaseFragment fragment, final boolean removeLast, boolean forceWithoutAnimation, boolean check) {
        ...
        boolean needAnimation = !forceWithoutAnimation && parentActivity.getSharedPreferences("mainconfig_"+ ApplicationLoader.currentUser, Activity.MODE_PRIVATE).getBoolean("view_animations", true);
    ...
    public void closeLastFragment(boolean animated) {
        ...
        setInnerTranslationX(0);
        boolean needAnimation = animated && parentActivity.getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE).getBoolean("view_animations", true);
