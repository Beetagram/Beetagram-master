...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
                ...
                if (position == textSizeRow) {
                    ...
                    cell.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            SharedPreferences.Editor editor = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE).edit();
    ...
    private void performAskAQuestion() {
        final SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE);
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.getString("emoji_"+ApplicationLoader.currentUser, R.string.Emoji), true);
                    }
                    break;
                }
                case 3: {
