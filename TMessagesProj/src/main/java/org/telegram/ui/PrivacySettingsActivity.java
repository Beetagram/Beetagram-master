        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (position == blockedRow) {
                    ...
                    ApplicationLoader.applicationContext.getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE).edit().putInt("secretWebpage2", MessagesController.getInstance().secretWebpagePreview).commit();
                    ...
                    new AlertDialog.Builder(getParentActivity())
							...
							.setItems(new String[]{
                                ...
                                @Override
                                public void onClick(DialogInterface dialog, int which){
                                    SharedPreferences prefs=getParentActivity().getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, Context.MODE_PRIVATE);
