...
public class ShareActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = ApplicationLoader.applicationContext.getSharedPreferences("botshare_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE);
