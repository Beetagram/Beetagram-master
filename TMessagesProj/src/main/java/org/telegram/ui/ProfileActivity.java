...
import sections.backend.FcmService.Setting.NoQuitContoller;
import sections.backend.FcmService.Setting.TurnQuitToHideController;
import sections.backend.FcmService.Setting.hideChannelController;
...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate {
    ...
    boolean showAdminTextView = false ;
    ...
    public boolean onFragmentCreate() {
        ...
        showAdminTextView = preferences.getBoolean("showAdminTextView", true);
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                if (position == sharedMediaRow) {
                    ...
                    for (int a = 0; a < descriptions.length; a++) {
                        ...
                        textView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (i == 0) {
                                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("Notifications_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setTitle(LocaleController.getString("Notifications_"+ApplicationLoader.currentUser, R.string.Notifications));
        ...
        adminTextView.setTextColor(Theme.getColor(Theme.key_actionBarDefaultTitle));
    ...
    private void leaveChatPressed() {
        ...
        if(TurnQuitToHideController.is(currentChat.username) || NoQuitContoller.isNoQuit(currentChat.username)){
    ...
    private void needLayout() {
        ...
        if (avatarImage != null) {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                adminTextView.setTranslationY((float) Math.floor(avatarY) + AndroidUtilities.dp(37) + (float) Math.floor(22 * AndroidUtilities.density) * diff);
            ...
            if (diff > 0.85 && showAdminTextView) {
...
//            }
            ...
            Log.i("TAG", "didReceivedNotification: type = "+type);
    ...
    public void setPlayProfileAnimation(boolean value) {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig_"+ApplicationLoader.currentUser, Activity.MODE_PRIVATE);
            ...
            switch (holder.getItemViewType()) {
                ...
                case 3:
                    ...
                    if (i == sharedMediaRow) {
                        ...
                        if (val != null) {
                            textCell.setTextAndValueAndIcon(LocaleController.getString("Notifications_"+ApplicationLoader.currentUser, R.string.Notifications), val, R.drawable.profile_list);
                        } else {
                            textCell.setTextAndValueAndIcon(LocaleController.getString("Notifications_"+ApplicationLoader.currentUser, R.string.Notifications), LocaleController.getString("NotificationsOff", R.string.NotificationsOff), R.drawable.profile_list);
                        }
