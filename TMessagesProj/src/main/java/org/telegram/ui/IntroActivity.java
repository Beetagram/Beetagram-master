...
import sections.backend.utils.LoginUtils;
...
public class IntroActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //* change the lanquage for first time
        ...
        LocaleController.getInstance().applyLanguage(localeInfo, true , true);


        //* pre login check is first open or not
        if (LoginUtils.isNewLogin()) {
...
//                LocaleController.getInstance().applyLanguage(localeInfo, true, false);
        ...
        lang.setImageResource(R.drawable.language);
        frameLayout.addView(lang, LayoutHelper.createFrame(35, 35, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0, 0, 25));
